...
public class TestMathOperator {
    ...
    @Test
    public void testGetStandardDeviationWithEmptyList() {
    ...
    @Test
    public void testGetStandardDeviationWithOneElement() {
    ...
    @Test
    public void testGetStandardDeviationWithNegativeNumbers() {
